...
@Component({
  selector: 'app-jua-mtoto-wako-filter',
  templateUrl: './jua-mtoto-wako-filter.component.html',
  styleUrls: ['./jua-mtoto-wako-filter.component.css']
})
export class JuaMtotoWakoFilterComponent implements OnInit, OnChanges {
