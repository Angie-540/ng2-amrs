...
@Component({
  selector: 'app-jua-mtoto-wako-tabular-view',
  templateUrl: './jua-mtoto-wako-tabular-view.component.html',
  styleUrls: ['./jua-mtoto-wako-tabular-view.component.css'] //
})
export class JuaMtotoWakoTabularViewComponent implements OnInit, OnChanges {
