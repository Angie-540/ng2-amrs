...
@Component({
  selector: 'app-jua-mtoto-wako-patient-list',
  templateUrl: './jua-mtoto-wako-patient-list.component.html',
  styleUrls: ['./jua-mtoto-wako-patient-list.component.css'] //
})
export class JuaMtotoWakoPatientListComponent implements OnInit {
  ...
  constructor(
    ...
    private moh412Service: JuaMtotoWakoResourceService
  ) {}
  ...
  private getPatientList(params: any) {
    this.moh412Service
      .getJuaMtotoWakoMonthlyReportPatientList(params)
      .subscribe((data: any) => {
